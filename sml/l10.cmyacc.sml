...
2 : Decl -> . LANNO ANNO_QUERY LCID COLON LCID Modes RANNO Decl  / 0
...
(0,8,(fn Value.decl(arg0)::Value.pos(arg1)::Value.modes(arg2)::Value.pos_str(arg3)::_::Value.pos_str(arg4)::_::Value.pos(arg5)::rest => Value.decl(Arg.Query {6=arg0,5=arg1,4=arg2,3=arg3,2=arg4,1=arg5})::rest|_=>raise (Fail "bad parser"))),
